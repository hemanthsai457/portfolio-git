    ...
    return (
        <div id="projects" className="proj-outer">
            ...
            <div className='proj-inner'>
                ...
                <br></br>
                <br></br>
                <a href="https://github.com/hemanthsai457/Tune-Therapy"><button className='view-but' type='button'>View</button></a>
            </div>
            <div className='proj-inner'>
                ...
                <a href='https://github.com/hemanthsai457/Forest-Fire-Prediction'><button className='view-but' type='button'>View</button></a>
            </div>
            <div className='proj-inner'>
                ...
                <br></br><br></br>
                <a href='https://github.com/hemanthsai457/Inventory-Optimization-and-Sales-Forecasting-Analysis'><button className='view-but' type='button'>View</button></a>
            </div>
            </div>
            <div className='proj-main-2'>
                <div className='proj-inner'>
                    ...
                    <p>Hi</p>
                    <br></br>
                    <a href='https://github.com/hemanthsai457/portfolio-git'><button className='view-but' type='button'>View</button></a>
                </div>
                <div className='proj-inner'>
                    ...
                    <br></br>
                    <br></br><br></br>
                    <a href='https://github.com/hemanthsai457/DeliDash'><button className='view-but' type='button'>View</button></a>
                </div>
                <div className='proj-inner'>
                    ...
                    <a href='https://github.com/hemanthsai457/Heartpulse-monitoring-and-notification-system'><button className='view-but' type='button'>View</button></a>
                </div>
            </div>
        </div>
    );
